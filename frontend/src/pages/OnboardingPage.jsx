...
import { CameraIcon, LoaderIcon, MapPinIcon, ShuffleIcon, Waypoints } from 'lucide-react';
...
const OnboardingPage = () => {
  ...
  const { mutate: onboardingMutation, isPending } = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["authUser"] });  // recall the /auth/me route
    },
    onError: (error) => {
        ...
        <div className="card-body p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button className="btn btn-primary w-full" disabled={isPending} type="submit">
              {!isPending ? (
                <>
                  <Waypoints className="size-5 mr-2" />
                  Complete Onboarding
                </>
              ) : (
                <>
